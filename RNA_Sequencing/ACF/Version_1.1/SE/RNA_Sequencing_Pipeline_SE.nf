...
process TrimInput {
 ...
 set +eu
 module load skewer
 skewer -x /lustre/haven/proj/UTK0032/software/Trimmomatic-0.36/adapters/adapters.fa -l 30 ${R} -o ${sampleID} >& ${sampleID}.trim_output
 """
}
...
process STAR {
 ...
 set +eu
 module load star 
 STAR --genomeDir ${params.ref_genome}/genome_index --readFilesIn ${R} --runThreadN 2 --outFileNamePrefix ${sampleID}. --outSAMtype BAM SortedByCoordinate
 """
}
